<!-- 회원가입을 처리하는 함수 -->
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" import="user.UserDTO, user.UserDAO, util.SHA256, java.io.PrintWriter"%>
<%@ page import='evaluation.EvaluationDAO, evaluation.EvaluationDTO'%>
<%
...
if (result == -1) {
	...
	PrintWriter script = response.getWriter();
	script.println("<script>");
	script.println("alert('성공적으로 강의 등록했습니다!');");
