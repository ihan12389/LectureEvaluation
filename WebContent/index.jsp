...
<!--  커스텀 CSS 추가하기  -->
<link rel="styl esheet" href="./css/custom.css">
</head>
<body>
	<%
	...
	//기본적으로 index 페이지는 강의종류="전체"에 검색타입="최신순"에 검색내용은 없다고 가정하고 게시물을 보여준다.
	...
	//그리고 request 객체를 검색해서 주어진 검색내용이나 설정이 있다면 반영하도록 해준다.
	...
	if (userID == null) {
		...
		script.println("alert('로그인을 하지 않은 상태입니다. 로그인을 해주세요.');");
	...
	//로그인 여부와 인증 메일 여부를 파악하여 적절한 대처를 하도록 해준다
	%>
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			<select name="lectureDivide" class="form-control mx-1 mt-2">
				...
				<option value="전공" <%if (lectureDivide.equals("전공"))
	out.println("selected");%>>전공</option>
				<option value="교양" <%if (lectureDivide.equals("교양"))
	out.println("selected");%>>교양</option>
				<option value="기타" <%if (lectureDivide.equals("기타"))
			...
			<div class="card-body">
				...
				<div class="row">
					<div class="col-9 text-left">
						성적 <span style="color: red;"><%=evaluation.getCreditScore()%></span> 널널 <span style="color: red;"><%=evaluation.getComfortableScore()%></span> 강의 <span style="color: red;"><%=evaluation.getLectureScore()%> </span> <span style="color: green;">(추천 : <%=evaluation.getLikeCount()%>)
						</span>
					</div>
 ...
 %>
		...
		<li>
			<%
				//5개까지 출력하는데 만약 사이즈가 6이라면 다음 페이지가 존재한다는 뜻이다
 ...
 %>
	...
	<footer class="bg-dark mt-4 p-5 text-center" style="color: #FFFFFF;"> Coptyright &copy; 2020 이한 All Right Reserved. </footer>
	<!--  제이쿼리 자바스크립트 추가하기 -->
